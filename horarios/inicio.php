...
{  	
    let urlPaginas=["CrearUsuarios.php", "ModificarUsuarios.php","reportes.php"];
...
<table width="100%" border="0">
  <tbody>
    ...
    <tr>
      ...
      <td width="267" align="center"><input name="button3" type="button" id="button3" value="Reporte" onClick="javascript:hacerSubmit(3)"></td>
      <td width="178">&nbsp;</td>
      <td width="14">&nbsp;</td>
    </tr>
  </tbody>
...
<div align="center" id="contenido">
  <p>&nbsp;</p>
  <p><b>------- Ejemplo bueno Cambio por git 2025 semaforo------</b></p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
</div>
